              ...
              <div className="ms-lg-4">
                ...
                <div className="section-title">
                  ...
                  <p className="text-muted">
                    ...
                    зовнішнього дихання. У корсеті передбачені зони тиску і зони
                    розвантаження, які відповідають за правильну дію корсета. За
                    рахунок жорсткої конструкції корсета тиск на хребет
                    відбувається постійно, що перешкоджає подальшому розвитку
                    сколіозу і змушує хребет вирівнюватися.
                  </p>
