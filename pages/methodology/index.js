            ...
            <Col lg={12} className="text-center">
              <div className="pages-heading title-heading">
                ...
                <p className="text-white-50 para-desc mb-0 mx-auto">
                  Ефективність терапевтичного впливу базується на
                  індивідуальному створенні корсета для кожного пацієнта
                </p>
              </div>
            </Col>
          </Row>
              ...
              <div className="ms-lg-4">
                ...
                <div className="section-title">
                  ...
                  <p className="text-muted">
                    Ортопедичний корсет був винайдений французьким лікарем Жаком
                    Шено з метою корекції та відновлення функцій хребта при
                    сколіозі та кіфозі. Він діє на тіло в трьох площинах:
                    фронтальній, сагітальній і горизонтальній. Це дозволяє
                    уникнути зниження фізіологічних показників функцій
                    зовнішнього дихання, а також атрофії м&apos;язів. У корсеті
                    передбачені зони тиску і зони розвантаження, які
                    відповідають за правильну дію корсета. За рахунок жорсткої
                    конструкції корсета тиск на хребет відбувається постійно, що
                    перешкоджає подальшому розвитку сколіозу і змушує хребет
                    вирівнюватися.
                  </p>
            ...
            <Col md={8}>
              <div className="section-title text-center text-md-start">
                ...
                <p className="text-muted mb-0 para-desc">
                  Важливо: якщо дитина почала носити корсет Шено, лікування не
                  можна зупиняти до закриття точок зростання, тобто до моменту,
                  коли дитина перестає рости. Якщо корсет скасувати раніше,
                  сколіоз не тільки повернеться, але і стане значно сильніше.
                  Закриття точок зростання визначається за рентгеном тазу.
                </p>
              </div>
            </Col>
          </Row>
