...
const Index = () => {
    const reviews = [
        ...
        },
        {
            id: 5,
            name: "Андрій",
            desc: "Дуже задоволений роботою спеціалістів Корсет Захід, підходять до своєї роботи дуже відповідально, вже два роки користуюсь їх послугами і реально бачу в доньки результат. Дякую Корсет Захід.",
            rating: 5,
        },
        {
            id: 6,
